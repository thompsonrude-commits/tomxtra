...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  saveEmailTemplate: (data: { name: string; subject: string; body: string }) => ipcRenderer.invoke('save-email-template', data),
  deleteEmailTemplate: (id: number) => ipcRenderer.invoke('delete-email-template', id),
